...
function fill_saints_field4()
{
    ...
    </ul><br />Если виджет календаря не установлен, при загрузке страницы с шорткодом описания жития будет отображаться информация текущего дня.<br />Если у Вас возникли вопросы или пожелания, вы можете направить их на siamajor@ukr.net', 'saints');
?>
